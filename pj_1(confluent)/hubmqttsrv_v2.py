    ...
    def handle_data(self, thread_id):        
        while True:
            ...
            try:                
                ...
                logging.info("$$$ 큐에서 꺼냄  N(M)->H DelayTime: {1}ms ({2} - {3}, ThreadId:{0})".format(thread_id, round(delay_time,4), start_str[11:], end_str[11:]))
                    ...
                    if _cmd == "rep":
                        ...
                        if _actn == "tractor":
                            ...
                            if _dtlActn == "planwrite":
                                ...
                                #print(json.loads(str(decoded_data)))
                                # DB 변수형으로 변환
                        ...
                        if _cmd == "req":                            
                            ...
                            if _actn == "alarm":
                                ...
                                if _dtlActn == "info":
                                    ...
                                    db_in_datas['"T_TIMESTAMP"'] = start_str
                ...
                if _cmd == "req" or _cmd == "cmd" or _cmd == "res" or replay_ok is True:                
                    ...
                    if len(_edgeId) > 15:
                        ...
                        for edgeId in edgeIds:
                            print(edgeId)
                            RES_TOPIC = self.PUB_EDGENODE_TOPIC + "/" + edgeId
