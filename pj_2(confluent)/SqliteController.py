...
여기서부터 본 컨트롤러 사용법
        ...
        sqlitectrl = SqliteController(dbfile)
...
class SqliteController:
    ...
    def base_select(self, condition):
        ...
        try:
            ...
            except sqlite3.err.InternalError as e:
                if e.args[0] == "":
                    pass
                else:
                    raise
...
if __name__ == "__main__":
    ...
    conditions = {'tablename': 'proc_cmd_list as a'}
    conditions['select'] = "a.*"
    conditions['orderby'] = " order by node_nm "

    result = sqlitectrl.base_select(conditions)
    data_len = result['totalcount']
    ...
    for item in result['datas']:
        atts = []
        #v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12 = item
        for v1 in item:
            atts.append(v1)
